...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/src/scripts/sortManage.js"></script>
...
<div id="wrap">
    ...
    <form name="Form1" id="Form1" method="post" cssStyle="margin:0px;" action="${pageContext.request.contextPath}/systemddl?type=new">
        <table cellSpacing="1" cellPadding="0" width="100%" bgColor="#f5fafe" border="0" class="form_table">
            <TBODY>
            <TR height=10>
                <td colspan=3></td>
            </TR>
            ...
            <tr>
                ...
                <td class="ta_01" align="left" width="30%" height=20 id="newddlText">
                    <input type="text" name="keywordname" id="keywordname" maxlength="25" size=24>
                </td>
