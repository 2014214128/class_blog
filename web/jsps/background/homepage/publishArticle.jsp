...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/src/scripts/publishArticle.js"></script>
</head>
<body>
<div id="wrap">
    <div class="head">
                ...
                <dd>
                    <ul>
                        <li class="user_name"><a href="${pageContext.request.contextPath}/jsps/background/homepage/updatePersonalInfo.jsp"
                                                 class="user_name">${sessionScope.user.loginname}</a><span><a href="${pageContext.request.contextPath}/showPage?pageNow=1">返回首页</a></span>
                        </li>
                        <li class="feed_link"><a href="${pageContext.request.contextPath}/jsps/background/homepage/updatePersonalInfo.jsp">修改个人信息</a>|
                            <a onclick="deleteUser(${sessionScope.user.id})">用户注销</a>
                        </li>
                    </ul>
                </dd>
            </dl>
    ...
    <form <%--action="${pageContext.request.contextPath}/article?type=publish"--%> action=""  id="form" name="form" method="post"
        ...
        <div id="d_desc">
            <textarea id="txtDesc" name="note" rows="6" style="width:99%;"></textarea>
        </div>
        ...
        <div class="section">
            ...
            <textarea id="editor" name="content" rows="30" cols="131"></textarea>
        </div>
        ...
        <div class="radioBox channel">
            <c:forEach items="${applicationScope.second_categoryList}" var="second_category">
                <input type="radio" class="radChs" name="second_category" id="radCh${second_category.ddlcode}"
                       value="${second_category.ddlcode}"><label
                    for="radCh${second_category.ddlcode}">${second_category.ddlname}</label>
            </c:forEach>
        </div>
