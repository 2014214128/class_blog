...
<head>
    ...
    <meta name="keywords" content="10个迹象表明程序员编码太久了"/>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/src/scripts/smohan.face.js"
    ...
    <h1>14-信1班级博客
        <c:choose>
            <c:when test="${sessionScope.user != null}">
                <a href="${pageContext.request.contextPath}/jsps/background/homepage/publishArticle.jsp"
                   style="font-size: 17px;float: right;color: #664666">欢迎您！${user.loginname}</a>
            </c:when>
            <c:otherwise>
                <a href="${pageContext.request.contextPath}/jsps/background/register.jsp"
                   style="font-size: 17px;float: right;color: #664666">注册</a>
                <a href="${pageContext.request.contextPath}/jsps/background/login.jsp"
                   style="font-size: 17px;float: right;color: #664666">登录|</a>
            </c:otherwise>
        </c:choose>
    </h1>
...
<div id="body">
    <div class="content_text"
         style="background-color:white;margin-top:20px;text-indent: 2em;font-size:16px;line-height:2em;">
        <br>
        <center><h2>${requestScope.article.title}</h2></center>
        <center>${requestScope.article.user.loginname}</center>
        <div id="Article_Category">
            <p>${requestScope.article.content}</p>
        </div>
        <div id="SOHUCS" sid="${requestScope.article.id}"></div>
        <script charset="utf-8" type="text/javascript" src="https://changyan.sohu.com/upload/changyan.js"></script>
        <script type="text/javascript">
            window.changyan.api.config({
                appid: 'cyt5RyAfq',
                conf: 'prod_48d1f9b5c427c79b119510c4fdedff23'
            });
        </script>
        ...
        <%--</p>--%>
        <%--</div>--%>
        <%--&lt;%&ndash;添加评论的显示, article.comment&ndash;%&gt;--%>
        <%--&nbsp;&nbsp;评论--%>
        <%--<hr/>--%>
        <%--//        <div id="Zones"></div>--%>
    </div>
    ...
    <div id="right">
        <div id="right-text">
            <ul>
                <li><img src="${pageContext.request.contextPath}/src/img/hot-recommend-img.png" width="200"
                         class="hot-recommend"><br>
                    <hr>
                </li>
                <c:forEach items="${requestScope.pageBeanRight.data}" var="article">
                    <li>
                        ...
                        <a href=" <c:url value="/show?type=show">
                            ...
                            <div style="width: 100px;height: 40px;overflow: hidden;">${article.title}</div>
                        </a>
                    </li>
                </c:forEach>
            </ul>
    ...
    <div class="footer-wrap">
        ...
        <p style="text-align: center;margin-top: 10px;margin-bottom: 20px">
            <span>备案号：<strong>皖ICP备17015032号</strong></span></p>
    </div>
</div>
<!--body结束-->
