...
<div id="content">
    <div id="top">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/showPage?pageNow=1">首页</a></li>
            <li>></li>
            <li><font color="#F00E71">学无止境</font></li>
        </ul>
    </div>
    <div class="body-top">
        <ul>
            <li><a href="${pageContext.request.contextPath}/article?type=search&pageNow=1&keyword=J2EE">J2EE</a></li>
            <li><a href="${pageContext.request.contextPath}/article?type=search&pageNow=1&keyword=Android">Android</a></li>
            <li><a href="${pageContext.request.contextPath}/article?type=search&pageNow=1&keyword=Web前端">Web前端</a></li>
            <li><a href="${pageContext.request.contextPath}/article?type=search&pageNow=1&keyword=数学">数学</a></li>
        </ul>
    </div>
</div>
<div id="body">
