...
<head>
    <meta charset="UTF-8">
    <title>回音墙</title>
    <meta name="keywords" content="回音墙" />
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/src/css/whispering_wall.css">
    <script type="text/javascript" src="${pageContext.request.contextPath}/src/scripts/whispering_wall.js"></script>
</head>
<body>
...
<div id="nav">
    <ul>
        ...
        <li>
            ...
            ">学无止境</a>
        <li><a href="${pageContext.request.contextPath}/jsps/whispering_wall.jsp" class="first-a">回音墙</a></li>
        <div class="clear"></div>
    </ul>
</div>
<div id="content">
    <div id="top">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/showPage?pageNow=1">首页</a></li>
            <li>></li>
            <li><font color="#F00E71">回音墙</font></li>
        </ul>
    </div>
    <div id="body">
        <div id="post">
